...
/// <summary>
/// FROZEN ordinal-to-name tables for the imphash computation, generated from
/// pefile's ordlookup/imphash_ws2_32.py and imphash_oleaut32.py (which mirror
/// YARA's pe_utils.c). DO NOT MODIFY the mappings: any change breaks
/// compatibility with the imphash values shown by VirusTotal/YARA/pefile.
/// wsock32.dll deliberately shares the ws2_32 table (original pefile behavior).
/// Ordinals of other DLLs render as "ordN".
/// Called from: PeAnalyzer.ComputeImphash.
/// </summary>
public static class PeImphashOrdinals
{
    /// <summary>
    /// Resolves an ordinal import to the frozen imphash name, or "ordN" when the
    /// DLL/ordinal is not in the tables. dllNameLower must be the FULL lowercase
    /// DLL name including extension (e.g. "ws2_32.dll").
    /// </summary>
    public static string Lookup(string dllNameLower, int ordinal)
    {
        var table = dllNameLower switch
        {
            "ws2_32.dll" or "wsock32.dll" => Ws2_32,
            "oleaut32.dll" => Oleaut32,
            _ => null
        };
        return table != null && table.TryGetValue(ordinal, out var name)
            ? name : $"ord{ordinal}";
    }

    private static readonly Dictionary<int, string> Ws2_32 = new()
    {
    ...
    private static readonly Dictionary<int, string> Oleaut32 = new()
    {
